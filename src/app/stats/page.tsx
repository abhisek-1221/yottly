      ...
      <Card className="border-gray-700 mb-6">
        <CardContent className="p-6">
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-400">
                {channelData?.username} • {channelData?.videosCount.toLocaleString()} videos
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 mt-6">
            <div className="bg-gray-700 py-3 text-center rounded">
              <p>Analytics</p>
            </div>
          </div>
        </CardContent>
                    ...
                    {viewsData.length > 0
                      ? viewsData.reduce((sum, item) => sum + item.views, 0) >= 1000000
                        ...
                        : viewsData.reduce((sum, item) => sum + item.views, 0) >= 1000
                          ...
                          : viewsData.reduce((sum, item) => sum + item.views, 0).toString()
                      : '0'}
                  </span>
              ...
              <CardContent>
                {recentVideos.length > 0 ? (
                  <>
                    ...
                    <p className="text-sm text-gray-400 mt-1">{recentVideos[0].uploadTime}</p>
                  ...
                  <div className="text-center text-gray-400 py-4">No recent videos found</div>
                )}
              </CardContent>
            </Card>
              ...
              <CardContent className="pt-4">
                ...
                <div className="h-[180px]">
                  <ResponsiveContainer width="100%" height="100%">
                    <AreaChart data={viewsData} margin={{ top: 10, right: 0, left: 0, bottom: 0 }}>
                      <defs>
          ...
          <Card className="border-gray-700 mt-4">
            ...
            <CardContent>
              <div className="grid grid-cols-3 gap-4">
                {recentVideos.slice(1, 7).map((video) => (
                  <VideoCard
                    key={video.videoId}
                    video={{
                      id: video.videoId,
